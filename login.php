                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <img class="col-lg-6 d-none d-lg-block" style="object-fit: contain;" src="https://apero.vn/wp-content/uploads/2023/01/Artboard-1-copy-3.png" alt="">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">APERO</h1>
                                    </div>
